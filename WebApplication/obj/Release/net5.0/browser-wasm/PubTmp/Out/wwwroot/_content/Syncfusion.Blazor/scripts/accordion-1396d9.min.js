...
var sfaccordion = function sfaccordion(exports) {
  ...
  function (_super) {
    ...
    __decorate([sf.base.Property()], AccordionItem.prototype, "id", void 0);
  ...
  function (_super) {
    ...
    Accordion.prototype.renderControl = function () {
      this.trgtEle = this.element.children.length > 0 ? sf.base.select('div', this.element) : null;
      this.renderItems();
      this.initItemExpand();
    };
    ...
    Accordion.prototype.renderInnerItem = function (item, index) {
      ...
      if (sf.base.isNullOrUndefined(item.id)) {
        item.id = innerEle.id;
      }
