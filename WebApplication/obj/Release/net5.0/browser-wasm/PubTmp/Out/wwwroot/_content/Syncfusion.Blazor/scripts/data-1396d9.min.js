...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/data.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _modules_data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/data.js */ "./modules/data.js");
/* harmony import */ var _modules_data_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_data_js__WEBPACK_IMPORTED_MODULE_0__);
    ...
    ODataV4Adaptor.prototype.onExpand = function (e) {
      ...
      selects.forEach(function (select) {
        ...
        if (splits.length == 2) {
          ...
          selected[splits[0]].push(exp + sel + close_1);
        }
  ...
  function () {
    ...
    DataManager.prototype.makeRequest = function (url, deffered, args, query) {
      ...
      var fnSuccess = function fnSuccess(data, request) {
        ...
        if (_this.isCustomDataAdaptor(_this.adaptor)) {
          request = sf.base.extend({}, _this.ajaxReqOption, request);
        }
    ...
    DataManager.prototype.saveChanges = function (changes, key, tableName, query, original) {
      ...
      if (!sf.base.isNullOrUndefined(this.adaptor[doAjaxRequest])) {
        ...
        var ajax_2 = new sf.base.Ajax(req);
    ...
    DataManager.prototype.successFunc = function (record, request) {
      ...
      if (this.isCustomDataAdaptor(this.adaptor)) {
        request = sf.base.extend({}, this.ajaxReqOption, request);
      }
    ...
    DataManager.prototype.doAjaxRequest = function (res, ajaxFunc) {
      ...
      if (!this.isCustomDataAdaptor(this.adaptor)) {
        var ajax_3 = new sf.base.Ajax(res);
