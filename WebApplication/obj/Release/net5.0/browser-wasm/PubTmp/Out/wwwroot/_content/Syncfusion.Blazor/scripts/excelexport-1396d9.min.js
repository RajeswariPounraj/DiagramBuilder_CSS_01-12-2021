...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/excelexport.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./bundles/excelexport.js":
/*!********************************!*\
  !*** ./bundles/excelexport.js ***!
  \********************************/
/*! no exports provided */
...
/* harmony import */ var _modules_excelexport_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/excelexport.js */ "./modules/excelexport.js");
/* harmony import */ var _modules_excelexport_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_excelexport_js__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./modules/excelexport.js":
/*!********************************!*\
  !*** ./modules/excelexport.js ***!
  \********************************/
...
window.sf.excelexport = function (exports) {
  'use strict';
  /**
   * CellStyle class
   * @private
  ...
  function () {
    function ValueFormatter(cultureName) {
      this.intl = new sf.base.Internationalization(); // if (!isNullOrUndefined(cultureName)) {
  ...
  function () {
    ...
    function Workbook(json, saveType, culture, currencyString, separator) {
      ...
      this.intl = new sf.base.Internationalization(this.culture);
      this.mSaveType = saveType;

      if (saveType === 'xlsx') {
        this.mArchive = new sf.compression.ZipArchive();
        this.sharedString = [];
        this.mFonts = [];
        this.mBorders = [];
        this.mStyles = [];
    ...
    Workbook.prototype.saveWorksheet = function (sheet, index) {
      ...
      if (sheet.rows !== undefined) {
        for (var _b = 0, _c = sheet.rows; _b < _c.length; _b++) {
          ...
          if (!sf.base.isNullOrUndefined(row.spans)) {
    ...
    Workbook.prototype.addToArchive = function (xmlString, itemName) {
      if (typeof xmlString === 'string') {
        ...
        var archiveItem = new sf.compression.ZipArchiveItem(blob, itemName);
        this.mArchive.addItem(archiveItem);
      } else {
        var archiveItem = new sf.compression.ZipArchiveItem(xmlString, itemName);
        this.mArchive.addItem(archiveItem);
      }
    };
  ...
  exports.BuiltInProperties = BuiltInProperties;
