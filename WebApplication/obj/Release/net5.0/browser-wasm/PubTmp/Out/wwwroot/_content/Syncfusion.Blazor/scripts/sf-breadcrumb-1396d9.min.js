...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/sf-breadcrumb.js");
/******/ })
/************************************************************************/
/******/ ({
...
window.sfBlazor.Breadcrumb = function () {
  ...
  var Breadcrumb = {
    initialize: function initialize(element, dotnetRef, overflowMode, maxItems) {
      if (element) {
        new SfBreadcrumb(element, dotnetRef, overflowMode, maxItems);
      }
    },
    calculateMaxItems: function calculateMaxItems(element, overflowMode) {
      if (element) {
        if (element.blazor__instance) {
          element.blazor__instance.overflowMode = overflowMode;
          element.blazor__instance.calculateMaxItems();
        }
      }
    },
    openPopup: function openPopup(element, menu, popup, dotnetRef) {
      if (element) {
        if (!element.blazor__instance) {
