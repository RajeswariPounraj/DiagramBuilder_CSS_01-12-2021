...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/sf-contextmenu.js");
/******/ })
/************************************************************************/
/******/ ({
...
window.sfBlazor.ContextMenu = function () {
  ...
  var ContextMenu = {
    initialize: function initialize(element, target, filter, showOn, dotnetRef) {
      if (!sf.base.isNullOrUndefined(element)) {
        new SfContextMenu(element, target, filter, showOn, dotnetRef);
      }
    },
    contextMenuPosition: function contextMenuPosition(element, left, top, isRtl, subMenu, isCollision) {
    ...
    subMenuPosition: function subMenuPosition(element, isRtl, showOnClick, isNull) {
      if (!sf.base.isNullOrUndefined(element) && !sf.base.isNullOrUndefined(element.blazor__instance)) {
        var cmenu = element.blazor__instance.hideMenu();
        element.blazor__instance.subMenuPosition(cmenu, isRtl, showOnClick, isNull);
      }
    },
    onPropertyChanged: function onPropertyChanged(element, key, result) {
      if (!sf.base.isNullOrUndefined(element) && !sf.base.isNullOrUndefined(element.blazor__instance)) {
