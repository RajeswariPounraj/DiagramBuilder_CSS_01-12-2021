...
window.sfBlazor.Schedule = function () {
  ...
  function (_super) {
    ...
    MonthEvent.prototype.setMaxEventHeight = function (event, cell, cellHeight) {
      ...
      var height = cellHeight - headerHeight - (this.maxHeight ? 0 : this.moreIndicatorHeight);
  ...
  function (_super) {
    ...
    Month.prototype.getMonthStart = function (currentDate) {
      var isInitial = this.parent.uiStateValues.isInitial && this.parent.options.currentView === 'Month' && !sf.base.isNullOrUndefined(this.parent.activeViewOptions.displayDate);
      var date = isInitial ? new Date(this.parent.activeViewOptions.displayDate) : !this.parent.uiStateValues.isInitial && this.isCustomMonth() ? currentDate : firstDateOfMonth(currentDate);
