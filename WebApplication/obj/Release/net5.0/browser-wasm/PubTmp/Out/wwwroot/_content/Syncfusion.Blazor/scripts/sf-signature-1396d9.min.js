...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/sf-signature.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./bundles/sf-signature.js":
/*!*********************************!*\
  !*** ./bundles/sf-signature.js ***!
  \*********************************/
/*! no exports provided */
...
/* harmony import */ var _modules_sf_signature_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/sf-signature.js */ "./modules/sf-signature.js");
/* harmony import */ var _modules_sf_signature_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_sf_signature_js__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./modules/sf-signature.js":
/*!*********************************!*\
  !*** ./modules/sf-signature.js ***!
  \*********************************/
...
window.sfBlazor.Signature = function () {
  'use strict';
  ...
  function (_super) {
    ...
    SignatureBase.prototype.initialize = function (element, parameter) {
    ...
    SignatureBase.prototype.wireEvents = function () {
      if (this.pointColl === undefined && !this.isReadOnly && !this.disabled) {
        sf.base.EventHandler.add(this.canvasContext.canvas, 'mousedown touchstart', this.mouseDownHandler, this);
        sf.base.EventHandler.add(document, 'keydown', this.keyboardHandler, this);
        window.addEventListener('resize', this.resizeHandler.bind(this));
      } else if (this.pointColl) {
        sf.base.EventHandler.add(this.canvasContext.canvas, 'mousemove touchmove', this.mouseMoveHandler, this);
        sf.base.EventHandler.add(this.canvasContext.canvas, 'mouseup touchend', this.mouseUpHandler, this);
      }
    };

    SignatureBase.prototype.unwireEvents = function (type) {
      if (type === 'mouseup' || type === 'touchend') {
        sf.base.EventHandler.remove(this.canvasContext.canvas, 'mousemove touchmove', this.mouseMoveHandler);
        sf.base.EventHandler.remove(this.canvasContext.canvas, 'mouseup touchend', this.mouseUpHandler);
      } else {
        sf.base.EventHandler.remove(this.canvasContext.canvas, 'mousedown touchstart', this.mouseDownHandler);
        sf.base.EventHandler.remove(document, 'keydown', this.keyboardHandler);
    ...
    SignatureBase.prototype.keyboardHandler = function (e) {
      ...
      switch (e.keyCode) {
        ...
        case  true && 83:
          this.trigger('beforeSave', args, function (observedChangeArgs) {
            _this.save(observedChangeArgs.type, observedChangeArgs.fileName);
          });
          e.preventDefault();
    ...
    SignatureBase.prototype.resizeHandler = function () {
      ...
      bitmapImage.onload = function () {
        Promise.all([createImageBitmap(bitmapImage, 0, 0, proxy.element.width, proxy.element.height)]).then(function (results) {
    ...
    SignatureBase.prototype.point = function (x1, y1, time1) {
      this.clientX = x1;
      this.clientY = y1;
    ...
    SignatureBase.prototype.addPoint = function (point) {
      ...
      if (!lastPoint || !(lastPoint && isLastPointTooClose)) {
        ...
        if (points.length > 2) {
          ...
          this.controlPoint1 = cp2;
          this.controlPoint2 = cp3;
    ...
    SignatureBase.prototype.enableDisable = function (isDisable) {
    ...
    SignatureBase.prototype.updateSnapCollection = function () {
      if (sf.base.isNullOrUndefined(this.incStep)) {
        this.incStep = -1;
        this.incStep++;
        this.snapColl = [];
      } else {
    ...
    SignatureBase.prototype.saveBackground = function (imageSrc) {
      // eslint-disable-next-line @typescript-eslint/no-this-alias
      var proxy = this;
    ...
    SignatureBase.prototype.loadPerstsistedSignature = function () {
    ...
    SignatureBase.prototype.undo = function () {
      ...
      if (this.incStep > 0) {
        ...
        undoImg_1.onload = function () {
          proxy.canvasContext.clearRect(0, 0, proxy.element.width, proxy.element.height);
          proxy.canvasContext.drawImage(undoImg_1, 0, 0);
        };
      }
    };
    /**
    ...
    SignatureBase.prototype.redo = function () {
      ...
      if (this.incStep < this.snapColl.length - 1) {
        ...
        redoImg_1.onload = function () {
          proxy.canvasContext.clearRect(0, 0, proxy.element.width, proxy.element.height);
          proxy.canvasContext.drawImage(redoImg_1, 0, 0);
        };
      }
    };
    /**
    ...
    SignatureBase.prototype.isUndoEnabled = function () {
    ...
    SignatureBase.prototype.isRedoEnabled = function () {
    ...
    SignatureBase.prototype.getSignature = function () {
    ...
    SignatureBase.prototype.save = function (type, fileName) {
      ...
      type = type || 'png';
      var dataURL = this.canvasContext.canvas.toDataURL('image/' + type);
    ...
    SignatureBase.prototype.onPropertyChanged = function (newProp, oldProp) {// On Property Changed
    };
    /**
    ...
    SignatureBase = __decorate([sf.base.NotifyPropertyChanges], SignatureBase);
  ...
  /** @class */
  function () {
    function Sfsignature(element, parameter) {
      this.element = element;
      this.element.blazor__instance = this;
    }

    Sfsignature.prototype.initialize = function (element, parameter) {
      SignatureBase.prototype.initialize(element, parameter);
    };

    Sfsignature.prototype.getSignature = function (element) {
      var context = element.getContext('2d');
      return context.canvas.toDataURL('image/png');
    };

    Sfsignature.prototype.saveAsBlob = function (element) {
      var context = element.getContext('2d');
      return SignatureBase.prototype.getBlob(context.canvas.toDataURL('image/png'));
    };

    Sfsignature.prototype.destroy = function () {
      SignatureBase.prototype.destroy();
    };
  ...
  var Signature = {
    initialize: function initialize(element, parameter) {
      if (!sf.base.isNullOrUndefined(element)) {
        new Sfsignature(element, parameter);
        element.blazor__instance.initialize(element, parameter);
      }
    },
    clear: function clear() {
      SignatureBase.prototype.clear();
    },
    undo: function undo() {
      SignatureBase.prototype.undo();
    },
    redo: function redo() {
      SignatureBase.prototype.redo();
    },
    save: function save(type, fileName) {
      SignatureBase.prototype.save(type, fileName);
    },
    draw: function draw(text, fontFamily, fontSize) {
      SignatureBase.prototype.draw(text, fontFamily, fontSize);
    },
    load: function load(signature, width, height) {
      SignatureBase.prototype.load(signature, width, height);
    },
    getSignature: function getSignature(element) {
      return element.blazor__instance.getSignature(element);
    },
    saveAsBlob: function saveAsBlob(element) {
      return element.blazor__instance.saveAsBlob(element);
    },
    onPropertyChanged: function onPropertyChanged(key, value) {
      SignatureBase.prototype.propertyChanged(key, value);
    },
