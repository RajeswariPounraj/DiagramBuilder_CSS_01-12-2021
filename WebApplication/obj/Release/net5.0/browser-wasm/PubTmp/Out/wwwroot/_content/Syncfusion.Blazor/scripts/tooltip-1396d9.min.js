...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/tooltip.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _modules_tooltip_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/tooltip.js */ "./modules/tooltip.js");
/* harmony import */ var _modules_tooltip_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_tooltip_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sftooltip = function sftooltip(exports) {
  'use strict';
  ...
  function (_super) {
    ...
    Tooltip.prototype.renderContent = function (target) {
      var tooltipContent = sf.base.select('.' + CONTENT, this.tooltipEle);
      ...
      if (!sf.base.isNullOrUndefined(this.content)) {
        ...
        if (this.content instanceof HTMLElement) {
          ...
          if (this.enableHtmlSanitizer) {
            this.setProperties({
              content: sf.base.SanitizeHtmlHelper.sanitize(this.content)
            }, true);
          }
    ...
    Tooltip.prototype.beforeRenderCallback = function (beforeRenderArgs, target, e, showAnimation) {
      if (beforeRenderArgs.cancel) {
        ...
        if (sf.base.isNullOrUndefined(this.tooltipEle)) {
          this.ctrlId = this.element.getAttribute('id') ? sf.base.getUniqueID(this.element.getAttribute('id')) : sf.base.getUniqueID('tooltip');
          this.tooltipEle = this.createElement('div', {
            ...
            styles: 'width:' + sf.base.formatUnit(this.width) + ';height:' + sf.base.formatUnit(this.height) + ';position:absolute;'
          });
    ...
    Tooltip.prototype.appendContainer = function (ctrlObj) {
      if (typeof this.container == 'string') {
        if (this.container === 'body') {
          ...
          this.containerElement = sf.base.select(this.container, document);
        }
    ...
    Tooltip.prototype.needTemplateReposition = function () {
      // eslint-disable-next-line
      var tooltip = this;
      return !sf.base.isNullOrUndefined(tooltip.viewContainerRef) && typeof tooltip.viewContainerRef !== 'string';
    };
    ...
    Tooltip.prototype.collisionFlipFit = function (target, x, y) {
      ...
      if (elePos.position !== newpos) {
        var pos = sf.popups.calculatePosition(target, elePosHorizontal, elePosVertical, !this.isBodyContainer, this.isBodyContainer ? null : this.containerElement.getBoundingClientRect());
    ...
    Tooltip.prototype.tooltipHide = function (hideAnimation, e, targetElement) {
      ...
      if (e) {
        ...
        target = sf.base.select('[data-tooltip-id= "' + this.ctrlId + '_content"]', document);
      }
    ...
    Tooltip.prototype.wireFocusEvents = function () {
      if (!sf.base.isNullOrUndefined(this.target)) {
        var targetList = [].slice.call(sf.base.selectAll(this.target, this.element));
    ...
    Tooltip.prototype.findTarget = function () {
      var target = sf.base.select('[data-tooltip-id= "' + this.ctrlId + '_content"]', document);
      return target;
    };
    /**
    ...
    __decorate([sf.base.Property('auto')], Tooltip.prototype, "width", void 0);

    __decorate([sf.base.Property('auto')], Tooltip.prototype, "height", void 0);

    __decorate([sf.base.Property()], Tooltip.prototype, "content", void 0);

    __decorate([sf.base.Property('body')], Tooltip.prototype, "container", void 0);

    __decorate([sf.base.Property()], Tooltip.prototype, "target", void 0);

    __decorate([sf.base.Property('TopCenter')], Tooltip.prototype, "position", void 0);

    __decorate([sf.base.Property(0)], Tooltip.prototype, "offsetX", void 0);

    __decorate([sf.base.Property(0)], Tooltip.prototype, "offsetY", void 0);

    __decorate([sf.base.Property(true)], Tooltip.prototype, "showTipPointer", void 0);

    __decorate([sf.base.Property(true)], Tooltip.prototype, "enableHtmlParse", void 0);

    __decorate([sf.base.Property(false)], Tooltip.prototype, "windowCollision", void 0);

    __decorate([sf.base.Property('Auto')], Tooltip.prototype, "tipPointerPosition", void 0);

    __decorate([sf.base.Property('Auto')], Tooltip.prototype, "opensOn", void 0);

    __decorate([sf.base.Property(false)], Tooltip.prototype, "mouseTrail", void 0);

    __decorate([sf.base.Property(false)], Tooltip.prototype, "isSticky", void 0);

    __decorate([sf.base.Complex({}, Animation$1)], Tooltip.prototype, "animation", void 0);

    __decorate([sf.base.Property(0)], Tooltip.prototype, "openDelay", void 0);

    __decorate([sf.base.Property(0)], Tooltip.prototype, "closeDelay", void 0);

    __decorate([sf.base.Property()], Tooltip.prototype, "cssClass", void 0);

    __decorate([sf.base.Property(false)], Tooltip.prototype, "enableHtmlSanitizer", void 0);

    __decorate([sf.base.Event()], Tooltip.prototype, "beforeRender", void 0);

    __decorate([sf.base.Event()], Tooltip.prototype, "beforeOpen", void 0);

    __decorate([sf.base.Event()], Tooltip.prototype, "afterOpen", void 0);

    __decorate([sf.base.Event()], Tooltip.prototype, "beforeClose", void 0);

    __decorate([sf.base.Event()], Tooltip.prototype, "afterClose", void 0);

    __decorate([sf.base.Event()], Tooltip.prototype, "beforeCollision", void 0);

    __decorate([sf.base.Event()], Tooltip.prototype, "created", void 0);

    __decorate([sf.base.Event()], Tooltip.prototype, "destroyed", void 0);
